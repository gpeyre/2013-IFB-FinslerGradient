...
namefile = [ '/Users/nardi/Dropbox/banach-optim/NumericalTests/results/man/' namegrad '-initial.eps'];
...
for i=1:niter   
   ...
   % plot energy 
    ...
    % plot iterations   
      ...
      namefile = ['/Users/nardi/Dropbox/banach-optim/NumericalTests/results/man/' nameiter '.eps'];
...
fig3 = figure(3);
namefile = ['/Users/nardi/Dropbox/banach-optim/NumericalTests/results/man/' namegrad '-evolution.eps'];
saveas(fig3, namefile);
print('-depsc', namefile);

fig2 = figure(2);
namefile = ['/Users/nardi/Dropbox/banach-optim/NumericalTests/results/man/' namegrad '-energy.eps'];
...
axis equal; axis off;
drawnow;
namefile = ['/Users/nardi/Dropbox/banach-optim/NumericalTests/results/man/' namegrad '-final.eps'];
